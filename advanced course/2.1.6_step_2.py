# Зодиак.
# Китайский гороскоп назначает животным годы в 112-летнем цикле.
...
# название связанного с ним животного.
...
# animals = 'Обезьяна Петух Собака Свинья Крыса Бык Тигр Заяц Дракон Змея Лошадь Овца'.split()
# year = int(input())
