...
# описывающих листки с фамилиями. На первой строке каждого блока указано количество фамилий n_in i
# , затем идёт n_in i строчек с фамилиями тех, кто был на уроке i-ом уроке.
#
...
for block in range(m):
    n = int(input())
    pupils = set(input() for _ in range(n))
    list_sets.append(pupils)

lesson_set = list_sets[0]

for next_lesson_set in list_sets:
    lesson_set = lesson_set.intersection(next_lesson_set)

print(*sorted(lesson_set), sep='\n')
