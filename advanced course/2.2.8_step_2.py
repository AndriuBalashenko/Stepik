...
# а ящерица травит Спока, в то время как Спок ломает ножницы,
...
if t == r:
    print('ничья')
elif (t == 'ножницы' and (r == 'бумага' or r == 'ящерица')) or (t == 'бумага' and (r == 'камень' or r == 'Спок')) or (
        t == 'камень' and (r == 'ножницы' or r == 'ящерица')) or (
        t == 'ящерица' and (r == 'Спок' or r == 'бумага')) or (t == 'Спок' and (r == 'ножницы' or r == 'камень')):
    print('Тимур')
else:
    print('Руслан')
