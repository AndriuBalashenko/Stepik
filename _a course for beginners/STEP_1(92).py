...
# древним традициям и использует шифр Цезаря. Это их и подвело, ведь данный шифр очень простой.
...
#  Вообще ничего не понял, решение списал из интернета.
#  Что за сдвиг, где этот диапазон цифр/(1≤ n≤ 25) – сдвиг/ в решениях?
#  Откуда цифры 26, 96, 97, 122 .. ?
